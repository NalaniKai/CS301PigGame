...
public class PigHumanPlayer extends GameHumanPlayer implements OnClickListener {
    ...
    public void receiveInfo(GameInfo info) {
        ...
        if( info instanceof PigGameState) {
            ...
            oppScoreTextView.setText("" + state.getScore2());
            ...
            switch ( state.getDieValue() ) {
                ...
                case 6:
                    ...
                    break;
                default:
                    dieImageButton.setImageResource(R.drawable.purple_delete_button);
                    break;
            }
        }
    }//receiveInfo
    ...
    public void onClick(View button) {
        ...
        if(button.equals(this.dieImageButton)){
            PigRollAction roll = new PigRollAction(this);
            game.sendAction(roll);
        }

        if( button.equals(this.holdButton)) {
